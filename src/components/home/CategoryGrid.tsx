...
export default function CategoryGrid() {
    ...
    const menImage = products.find(p => p.id === 'art-20')?.image || "/images/placeholder-men.jpg";
    const womenImage = products.find(p => p.id === 'art-35')?.image || "/images/placeholder-women.jpg";
    const customImage = "/images/custom.jpg";
